...
URL="https://${devops_user}:${devops_pat}@dev.azure.com/${devops_organization}/${devops_project}/_apis/git/repositories/${devops_repository_id}/pullRequests/${BITRISE_PULL_REQUEST}/statuses?api-version=7.1-preview.1"
